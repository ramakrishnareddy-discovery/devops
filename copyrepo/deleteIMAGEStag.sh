...
# STEP 1) ./<CURRENT_SCRIPT_NAME>.sh 10.0.31.225:5000 CLIENT-ms-demandplanner 0.snapshot.89,0.snapshot.90,3.5-10.98
...
if [ "$#" -eq "0" ] || [ "$1" == "-?" ] || [ "$1" == "--help" ];then
    ...
    echo "e.g. `basename $0` 10.0.31.225:5000 CLIENT-ms-demandplanner 0.snapshot.89,4.05-12,,3.12.0"
    exit 1
fi
