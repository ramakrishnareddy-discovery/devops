...
# STEP 1) ./<CURRENT_SCRIPT_NAME>.sh 10.0.31.225:5000 qualcomm-ms-demandplanner 0.snapshot.89
...
if [ "$#" -eq "0" ] || [ "$1" == "-?" ] || [ "$1" == "--help" ];then
    ...
    echo "e.g. `basename $0` 10.0.31.225:5000 qualcomm-ms-demandplanner 0.snapshot.89"
    exit 1
fi
